...
namespace SPaPS.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, SPaPsContext context, IEmailSenderEnhance _emailService)
        {
        ...
        public async Task<IActionResult> Login(LoginModel model)
        {
            ...
            Microsoft.AspNetCore.Identity.SignInResult? result = await _signInManager.PasswordSignInAsync(userName: model.Email, password: model.Password, isPersistent: false, lockoutOnFailure: true);
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordModel model)
        {
            ...
            var user = await _userManager.FindByEmailAsync(LoggedUserEmail);
